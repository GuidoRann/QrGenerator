  ...
  return (
    ...
    {isOpen && (
      <div className="animate-fade-in animate-duration-300 fixed inset-0 bg-black bg-opacity-30 backdrop-blur-sm flex flex-col justify-center items-center text-gray-200">
        <section className="bg-[#3c3a45] h-[48%] w-[90%] flex flex-col items-center rounded-xl">
        <button className="w-full flex justify-end px-2 py-3 font-black" onClick={onClose}><X size={25}/></button>
          ...
          <div className="pt-4">
            <button
              className="flex justify-center bg-purple-600 hover:bg-purple-700 px-12 py-3 md:px-7 md:py-3 cursor-pointer rounded-xl font-medium hover:scale-110 duration-300"
              onClick={onClose}
            >

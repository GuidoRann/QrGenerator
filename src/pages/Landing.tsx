...
export default function Landing() {
  return (
    <div className="flex flex-col justify-between items-center text-gray-200 bg-slate-800 font-Poppins">
        <h1 className="font-Lobster text-5xl font-black w-[85%] pt-14 bg-clip-text text-transparent bg-gradient-to-r from-secondary-color to-pink-600 text-center px-5 ">Hola Conectando Qr!</h1>
      <div className="flex flex-col justify-center items-center py-14 px-5">
        ...
        <section className="flex flex-col justify-center items-center gap-4">
          <div className="flex flex-col justify-center items-center p-6 gap-3 bg-slate-600 bg-opacity-35 rounded-2xl ">
            ...
            <p className="pb-4 text-gray-400">Genera códigos QR personalizados para tus enlaces, textos o información de contacto.</p>
              <Link 
              to="/creator"
          ...
          <div className="flex flex-col justify-between items-center p-6 gap-3 bg-slate-600 bg-opacity-35 rounded-2xl ">
            ...
            <h1 className="font-bold text-lg">Lee el codigo QR de una imagen</h1>
            <p className="pb-4 text-gray-400">Lee lo que tiene tu codigo QR desde una imagen sin necesidad de scanearlo con otro dispositivo.</p>
            <Link 
            to="/reader" 
            className="w-full flex justify-between p-3 items-center bg-primary-color hover:bg-hover-color transition-colors duration-300 rounded-xl font-medium">
        ...
        <section className="text-center mb-16 pt-14">
            <h2 className="text-3xl font-bold my-6 bg-clip-text text-transparent bg-gradient-to-r from-green-400 to-blue-500">¿Por qué elegir Conectando QR?</h2>
